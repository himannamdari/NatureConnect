...
# Page configuration - needs to be the first Streamlit command
st.set_page_config(
...
st.title("🌿 NatureConnect")
st.markdown("### Your companion for discovering and connecting with nature")
...
if page == "Home":
    st.header("Connect with Nature Around You")
    ...
    st.header("Find Nature Trails Near You")
    ...
    st.header("Discover Nature Events")
    ...
    st.header("Discover Your Connection to Nature")
